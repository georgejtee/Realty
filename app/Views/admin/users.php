                        ...
                        <td>
                            ...
                            <td class="text-right">
                                <?php if ($item['active'] == 0) : ?>
                                    <a class="btn btn-outline-secondary btn-sm" href="<?= base_url('Admin/enable/'.$item['id']) ?>"><i class="fas fa-user-check"></i> Enable</a>
                                <?php endif ?>

                                <a class="btn btn-outline-secondary btn-sm" href="<?= base_url('Admin/edit/'.$item['id'])?>"><i class="fas fa-edit"></i> Edit</a>
                                <a class="btn btn-outline-secondary btn-sm" href="<?= base_url('Admin/delete/'.$item['id']) ?>"><i class="fas fa-trash"></i> Delete</a>
                            </td>
                        </tr>
                    <?php endforeach;?>
                </tbody>
